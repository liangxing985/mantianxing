<template>
  <div>
    ...
    <van-list v-model:loading="loading" :finished="finished" finished-text="没有更多了" @load="loadData">
      <div v-for="msg in list" :key="msg.id" class="msg-item" :class="{ unread: !msg.isRead }" @click="readMsg(msg)">
...
const typeText = (t: string) => ({
  SYSTEM: '系统通知', ORDER: '订单通知', WALLET: '钱包通知',
}[t] || '通知')
...
.msg-item.unread { border-left-color: #6c5ce7; background: #f8f7ff; }
.msg-type { font-size: 13px; font-weight: 600; color: #6c5ce7; }
